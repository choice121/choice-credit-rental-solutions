...
import { Building2, LayoutDashboard, Users, UserPlus, MessageSquare, DollarSign, LogOut } from "lucide-react";
      ...
      <aside className="w-64 flex-shrink-0 border-r bg-sidebar hidden md:flex flex-col">
        <div className="p-6">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-serif text-xl font-bold tracking-tight text-sidebar-foreground">Choice Admin</span>
          </Link>
        </div>
