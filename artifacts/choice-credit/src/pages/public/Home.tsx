...
function FindYourPath() {
  const paths = [
    ...
    },
    {
      ...
      href: "/book?challenge=bad-credit&service=standard-housing",
      color: "hover:border-blue-400 hover:bg-blue-50/50",
    },
    {
      emoji: "📋",
      label: "I have an eviction on my record",
      desc: "A qualified co-signer to strengthen your application",
      href: "/book?challenge=eviction&service=co-signer",
      color: "hover:border-amber-400 hover:bg-amber-50/50",
    },
    {
      emoji: "💼",
      label: "I'm self-employed or freelance",
      desc: "Start with a full profile assessment",
      href: "/book?challenge=income-verification&service=assessment",
