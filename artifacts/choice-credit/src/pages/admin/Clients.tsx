...
import { Search, ChevronRight, User, Users } from "lucide-react";
                ...
                {isLoading ? (
                      ...
                      <div className="flex flex-col items-center justify-center py-16 gap-3 text-center">
                        ...
                        <p className="text-sm text-muted-foreground max-w-xs">
                          {search
                            ...
                            : "Clients will appear here once they sign up and create a case."}
                        </p>
                      </div>
                    </td>
                  </tr>
                  ...
                  clients.map((client) => (
                    <tr key={client.id} className="hover:bg-muted/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <Badge
                          variant={client.caseStatus === "approved" ? "default" : "secondary"}
                        >
                          {client.caseStatus
                            ? client.caseStatus.replace("_", " ")
                            : "No Case"}
                        </Badge>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link
                          ...
                          className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-muted text-muted-foreground hover:text-foreground"
